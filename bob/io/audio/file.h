 ...
 * @date Wed 20 Jan 2016 13:43:07 CET
 *
 * @brief Implements audio support using SoX
 *
 * Copyright (C) 2011-2016 Idiap Research Institute, Martigny, Switzerland
 */

#ifndef BOB_IO_AUDIO_FILE_H
#define BOB_IO_AUDIO_FILE_H
